...
(friction_surface/friction_inputs/lulc.tif) so the figure can never drift
...
REF_RASTER = "friction_surface/friction_inputs/lulc.tif"
STATES_SHP = "inputs/region_and_census_data/tiger/cb_2023_us_state_500k.shp"
OUT_STEM = "outputs/figures/ak_stack_150m_reference_grid"
