...
| File | Role |
|---|---|
| `friction_surface/friction_inputs/lulc.tif` | Dynamic World v1 mode composite, EPSG:3338, 150 m, uint8 |
| `friction_surface/friction_inputs/slope.tif` | FABDEM-derived slope in degrees, float32 |
...
`friction_surface/friction_inputs/` and the corridor masks in
