...
Run:  python workflows/02_network_build/05_verify_north_slope.py   (after 04_build_network.py)
"""
...
def main() -> None:
    stem = PROJ / "output" / "03_network"
    if not (stem.parent / "03_network__edges.gpkg").exists():
        raise SystemExit("no outputs/02_network_build/output/03_network — run: "
