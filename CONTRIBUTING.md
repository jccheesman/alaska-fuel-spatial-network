...
Issues and pull requests are welcome. Please note that the frozen network-of-record (`final_network/*.zip`) and the cost and friction constants (`source_scripts/friction_surface/friction_costs.py`, `friction_config.py`) change only by decision of the repository owners; if you wish to propose changes to these components, please open an issue first to discuss your proposal.
