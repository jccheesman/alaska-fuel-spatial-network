...
|---|---|---|---|
| `inputs/gee_exports/AK_Stack_150m.zip` | ~5 GB | **Located (2026-08-06): the owner's machine** — the June narrow-grid export generation, kept as provenance. The CANONICAL wide-grid layers live in the owner's `friction_rasters` working set. | To regenerate from nothing: run `src/friction_surface/friction_preprocessing/gee_friction_layer_multi_data_processing.js` in the GEE Code Editor (use the 28,001-column extended grid). |
